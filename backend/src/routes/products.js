...
// GET /api/products — public, used to populate the order form
...
// PATCH /api/products/:id — edit name, price, or toggle availability
router.patch('/:id', requireAuth, async (req, res) => {
  try {
    const { name, price_per_kg, is_available } = req.body;
    const fields = [], params = [];
    let i = 1;
